...
const SampleRequisitionForm = () => {
  ...
  const [volunteerDetailsOpen, setVolunteerDetailsOpen] = useState(false)
  const [screeningDetailsOpen, setScreeningDetailsOpen] = useState(false)
  const [projectInfoOpen, setProjectInfoOpen] = useState(false)
  const [hivCounsellingOpen, setHivCounsellingOpen] = useState(false)
  const [fastingInfoOpen, setFastingInfoOpen] = useState(false)
  const [testsPanelsOpen, setTestsPanelsOpen] = useState(false)

  // Add styles for sections and fields
  const sectionStyle = {
    display: 'flex',
    alignItems: 'center',
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
          ...
          <CardContent>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  <Box sx={sectionStyle} onClick={() => setVolunteerDetailsOpen(!volunteerDetailsOpen)}>
                    <Typography variant='h6' gutterBottom>
                      Volunteer Details
                    </Typography>
                    <IconButton size='small'>
                      {volunteerDetailsOpen ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
                    </IconButton>
                  </Box>
                </Grid>
                <Grid item xs={9}>
                  <Collapse in={volunteerDetailsOpen}>
                ...
                <Grid item xs={12}>
                  <Box sx={sectionStyle} onClick={() => setScreeningDetailsOpen(!screeningDetailsOpen)}>
                    <Typography variant='h6' gutterBottom>
                      Screening Details
                    </Typography>
                    <IconButton size='small'>
                      {screeningDetailsOpen ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
                    </IconButton>
                  </Box>
                </Grid>
                <Grid item xs={9}>
                  <Collapse in={screeningDetailsOpen}>
                    <Grid container spacing={2}>
                      <Grid item xs={12} md={6}>
                        <Controller
                ...
                <Grid item xs={12}>
                  <Box sx={sectionStyle} onClick={() => setProjectInfoOpen(!projectInfoOpen)}>
                    <Typography variant='h6' gutterBottom>
                      Project Information
                    </Typography>
                    <IconButton size='small'>
                      {projectInfoOpen ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
                    </IconButton>
                  </Box>
                </Grid>
                <Grid item xs={9}>
                            ...
                            <Controller
                              ...
                              render={({ field, fieldState: { error } }) => (
                                <FormControl fullWidth error={!!error} size='small'>
                                  ...
                                  <Select {...field} label='Project' sx={fieldStyle}>
                            ...
                            <Controller
                              ...
                              render={({ field, fieldState: { error } }) => (
                                <FormControl fullWidth error={!!error} size='small'>
                                  ...
                                  <Select {...field} label='Visit' disabled={!form.watch('studyType')} sx={fieldStyle}>
                                    {visits.map(visit => (
                            ...
                            <Controller
                              ...
                              render={({ field, fieldState: { error } }) => (
                                <FormControl fullWidth error={!!error} size='small'>
                                  ...
                                  <Select {...field} label='Screening' disabled={!form.watch('visit')} sx={fieldStyle}>
                ...
                {/* HIV Counselling Section */}
                <Grid item xs={12}>
                  <Box sx={sectionStyle} onClick={() => setHivCounsellingOpen(!hivCounsellingOpen)}>
                    <Typography variant='h6' gutterBottom>
                      HIV Counselling
                    </Typography>
                    <IconButton size='small'>
                      {hivCounsellingOpen ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
                    </IconButton>
                  </Box>
                </Grid>
                <Grid item xs={9}>
                  <Collapse in={hivCounsellingOpen}>
                    <Grid container spacing={2}>
                      <Grid item xs={12}>
                        <Controller
                ...
                {/* Fasting Information Section */}
                <Grid item xs={12}>
                  <Box sx={sectionStyle} onClick={() => setFastingInfoOpen(!fastingInfoOpen)}>
                    <Typography variant='h6' gutterBottom>
                      Fasting Information
                    </Typography>
                    <IconButton size='small'>
                      {fastingInfoOpen ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
                    </IconButton>
                  </Box>
                </Grid>
                <Grid item xs={9}>
                  <Collapse in={fastingInfoOpen}>
                    <Grid container spacing={2}>
                      <Grid item xs={12} md={6}>
                        <Controller
                          name='fastingSince'
                ...
                <Grid item xs={12}>
                  <Box sx={sectionStyle} onClick={() => setTestsPanelsOpen(!testsPanelsOpen)}>
                    <Typography variant='h6' gutterBottom>
                      Tests and Panels
                    </Typography>
                    <IconButton size='small'>
                      {testsPanelsOpen ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
                    </IconButton>
                  </Box>
                </Grid>
                <Grid item xs={9}>
                  <Collapse in={testsPanelsOpen}>
                    <Grid container spacing={2}>
                      <Grid item xs={12}>
                        <Controller
                          name='panels'
      ...
      <Dialog open={showSuccessDialog} onClose={() => setShowSuccessDialog(false)}>
        ...
        <DialogContent>
          <Typography>Requisition Request Created Successfully</Typography>
        </DialogContent>
        <DialogActions>
