...
const SampleRegistrationForm = ({ initialData, mode = 'create', onClose }: SampleRegistrationFormProps) => {
  ...
  const onSubmit = async (data: HumanFormData | AnimalFormData) => {
    try {
      ...
      const url =
        mode === 'edit' ? `/api/apps/lims/sample-registration/${initialData.id}` : '/api/apps/lims/sample-registration'
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  <TextField {...field} label='Employee ID' error={!!error} helperText={error?.message} fullWidth />
                )}
              />
              <Controller
          ...
          <form onSubmit={animalForm.handleSubmit(onSubmit)}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <Controller
                ...
                render={({ field, fieldState: { error } }) => (
                  <TextField {...field} label='Animal ID' error={!!error} helperText={error?.message} fullWidth />
                )}
              />
              ...
              <Controller
                ...
                control={animalForm.control}
                render={({ field, fieldState: { error } }) => (
                  <TextField {...field} label='Species' error={!!error} helperText={error?.message} fullWidth />
                )}
              />
              ...
              <Controller
                ...
                control={animalForm.control}
                render={({ field, fieldState: { error } }) => (
                  <TextField {...field} label='Requested By' error={!!error} helperText={error?.message} fullWidth />
                )}
              />
              ...
              <Controller
                ...
                control={animalForm.control}
                render={({ field, fieldState: { error } }) => (
                  <TextField {...field} label='Strain' error={!!error} helperText={error?.message} fullWidth />
                )}
              />
