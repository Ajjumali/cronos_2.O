...
//           })}
//     >
//       Incase you also want to scroll NavHeader to scroll with Vertical Menu, remove NavHeader from above and paste it
//       below this comment
//       {/* Vertical Menu */}
//       <Menu
...
//           </SubMenu>
//           <SubMenu label={dictionary['navigation'].lims} icon={<i className='tabler-microscope' />}>
//             <MenuItem href={`/${locale}/apps/lims/sample-received`}>{dictionary['navigation'].sampleReceived}</MenuItem>
//             <SubMenu label={dictionary['navigation'].instrument}>
//               <MenuItem href={`/${locale}/apps/lims/instrument/list`}>{dictionary['navigation'].list}</MenuItem>
//             </SubMenu>
//             <MenuItem href={`/${locale}/apps/lims/species-master`}>{dictionary['navigation'].Species}</MenuItem>
//             <MenuItem href={`/${locale}/apps/lims/analytecode-master`}>{dictionary['navigation'].Analytecode}</MenuItem>
//             <MenuItem href={`/${locale}/apps/lims/strain-master`}>{dictionary['navigation'].Strain}</MenuItem>
//           </SubMenu>
    ...
    >
      ...
      >
        {menuData && menuData.length > 0 ? (
          ...
          // Fallback to default menu if no dynamic menu data is available
          <SubMenu
            label={dictionary['navigation'].dashboards}
            icon={<i className='tabler-smart-home' />}
            suffix={<CustomChip label='5' size='small' color='error' round='true' />}
